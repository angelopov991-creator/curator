...
import { DOC_TYPE_OPTIONS, FILTER_OPTIONS, DEFAULT_FILTERS, DocType } from '@/types'
...
export default function DocumentUploader({ onSuccess }: Props) {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      // Step 2: Process & chunk via Flowise
      ...
      // Step 3: Enrich first batch of chunks
      setStatusText('✨ Enriching chunks with AI metadata...')
      setProgress(80)

      await enrichDocumentChunks(documentId, docType, 10) // First 10 chunks
