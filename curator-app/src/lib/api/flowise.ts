import { FlowiseChunk, FlowiseMetadata, FlowiseEmbedResult } from '@/types'

const FLOWISE_URL = process.env.NEXT_PUBLIC_FLOWISE_URL
const FLOWISE_API_KEY = process.env.FLOWISE_API_KEY
const FLOW1_ID = process.env.FLOW1_ID // Document Processor
const FLOW2_ID = process.env.FLOW2_ID // Metadata Enricher
const FLOW3_OPENAI_ID = process.env.FLOW3_OPENAI_ID // Vector Embedder OpenAI
const FLOW3_GEMINI_ID = process.env.FLOW3_GEMINI_ID // Vector Embedder Gemini
